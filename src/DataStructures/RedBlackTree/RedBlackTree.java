...
public class RedBlackTree {
    ...
    private Node root  = nil; // Root node
    ...
    private void RBInsert(RedBlackTree T, Node z){
        Node y = T.nil;
        Node x = T.root;
    ...
    private void transplantRBT(RedBlackTree T,Node u, Node v){
    ...
    private void deleteRBT(RedBlackTree T, Node z){
    ...
    private void deleteFixUpRBT(RedBlackTree T, Node x) {
        Node w;
    ...
    private Node treeSearch(Node x, int priority)
    {
    ...
    {
        Node temp = treeSearch(root, priority);
    ...
    public void insert(Patient patient) {
        Node temp = new Node(patient.getPriority(),BLACK, patient);
        RBInsert(this, temp);;
